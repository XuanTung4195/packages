...
struct CreationOptions: Hashable {
  ...
  var extraOption: [String: Any?]? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> CreationOptions? {
    ...
    let audioUri: String? = nilOrValue(pigeonVar_list[2])
    let extraOption: [String: Any?]? = nilOrValue(pigeonVar_list[3])
  ...
  static func == (lhs: CreationOptions, rhs: CreationOptions) -> Bool {
    ...
    return deepEqualsVideoPlayerPluginMessages(lhs.uri, rhs.uri) && deepEqualsVideoPlayerPluginMessages(lhs.httpHeaders, rhs.httpHeaders) && deepEqualsVideoPlayerPluginMessages(lhs.audioUri, rhs.audioUri) && deepEqualsVideoPlayerPluginMessages(lhs.extraOption, rhs.extraOption)
  }
  ...
  func hash(into hasher: inout Hasher) {
    ...
    deepHashVideoPlayerPluginMessages(value: audioUri, hasher: &hasher)
    deepHashVideoPlayerPluginMessages(value: extraOption, hasher: &hasher)
  }
}
...
class AVFoundationVideoPlayerApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AVFoundationVideoPlayerApi?, messageChannelSuffix: String = "") {
    ...
    /// TUNGPX
    let enablePictureInPictureChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.enablePictureInPicture\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      enablePictureInPictureChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let commandArg = args[0] as! String
        let dataArg: [String?: Any?]? = nilOrValue(args[1])
        do {
          let result = try api.enablePictureInPicture(command: commandArg, data: dataArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      enablePictureInPictureChannel.setMessageHandler(nil)
    }
  }
}
