...
class VideoPlayerInstanceApi {
  ...
  Future<Map<Object?, Object?>?> customMethod(String command, Map<String?, Object?>? data) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.VideoPlayerInstanceApi.customMethod$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
