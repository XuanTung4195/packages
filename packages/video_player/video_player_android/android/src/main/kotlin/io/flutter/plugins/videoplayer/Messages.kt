...
data class CreationOptions (
  ...
  val extraDatasource: List<Map<String?, String?>?>? = null
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): CreationOptions {
      ...
      val audioUri = pigeonVar_list[5] as String?
      val extraDatasource = pigeonVar_list[6] as List<Map<String?, String?>?>?
      return CreationOptions(uri, formatHint, httpHeaders, userAgent, backBufferDurationMs, audioUri, extraDatasource)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.audioUri)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.extraDatasource)
    return result
  }
}
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class SetDataSourceMessage (
  val uri: String? = null,
  val audioUri: String? = null,
  val extraDatasource: List<Map<String?, String?>?>? = null,
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): SetDataSourceMessage {
      val uri = pigeonVar_list[0] as String?
      val audioUri = pigeonVar_list[1] as String?
      val extraDatasource = pigeonVar_list[2] as List<Map<String?, String?>?>?
      val formatHint = pigeonVar_list[3] as String?
      val httpHeaders = pigeonVar_list[4] as Map<String?, String?>
      return SetDataSourceMessage(uri, audioUri, extraDatasource, formatHint, httpHeaders)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as SetDataSourceMessage
    return MessagesPigeonUtils.deepEquals(this.uri, other.uri) && MessagesPigeonUtils.deepEquals(this.audioUri, other.audioUri) && MessagesPigeonUtils.deepEquals(this.extraDatasource, other.extraDatasource) && MessagesPigeonUtils.deepEquals(this.formatHint, other.formatHint) && MessagesPigeonUtils.deepEquals(this.httpHeaders, other.httpHeaders)
  }
...
/** Generated class from Pigeon that represents data sent in messages. */
data class VideoResolutionMessage (
  val width: Long,
  val height: Long
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): VideoResolutionMessage {
      val width = pigeonVar_list[0] as Long
      val height = pigeonVar_list[1] as Long
      return VideoResolutionMessage(width, height)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as VideoResolutionMessage
...
/** Generated class from Pigeon that represents data sent in messages. */
data class VideoResolutionData (
  val width: Long,
  val height: Long
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): VideoResolutionData {
      val width = pigeonVar_list[0] as Long
      val height = pigeonVar_list[1] as Long
      return VideoResolutionData(width, height)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as VideoResolutionData
    return MessagesPigeonUtils.deepEquals(this.width, other.width) && MessagesPigeonUtils.deepEquals(this.height, other.height)
  }
...
private open class MessagesPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      145.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          SetDataSourceMessage.fromList(it)
        }
      }
      146.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          VideoResolutionMessage.fromList(it)
        }
      }
      147.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          VideoResolutionData.fromList(it)
        }
      }
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?)   {
    when (value) {
      ...
      is SetDataSourceMessage -> {
        stream.write(145)
        writeValue(stream, value.toList())
      }
      is VideoResolutionMessage -> {
        stream.write(146)
        writeValue(stream, value.toList())
      }
      is VideoResolutionData -> {
        stream.write(147)
        writeValue(stream, value.toList())
      }
...
interface VideoPlayerInstanceApi {
  ...
  /** TUNGPX */
  fun changeDataSource(msg: SetDataSourceMessage)
  fun setVideoResolution(msg: VideoResolutionMessage)
  fun getVideoResolutions(): List<VideoResolutionData>
  /**
   *
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: VideoPlayerInstanceApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.changeDataSource$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val msgArg = args[0] as SetDataSourceMessage
            val wrapped: List<Any?> = try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.setVideoResolution$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val msgArg = args[0] as VideoResolutionMessage
            val wrapped: List<Any?> = try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.getVideoResolutions$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              listOf(api.getVideoResolutions())
            } catch (exception: Throwable) {
              MessagesPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
